    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo $path; ?>/picture.php">Informações</a>
                </li>
            ...
            <form class="d-flex" role="search">
                <a class=" text-bg-dark btn" id="linkDeslogar" href="#">Deslogar</a>
                <a class=" text-bg-dark btn" id="linkLogar" href="#">Logar</a>
            </form>
        </div>
    </div>
</div>
