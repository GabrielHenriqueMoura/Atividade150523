    ...
    <div class="container">
        <div class="row mb-4 mt-4">
            <div class="alert alert-light" role="alert"style="background-color: #198754;">
                <h1  style="color: #000000;">Editar Área</h1>
            </div>
        </div>
        <?php
        try{
        ...
        <input value="<?php echo $linha['idArea'] ?>" type="text" name="idArea" id="idArea" hidden>
            <div class="row mb-3">
                <div class="col col-md-12">
                    ...
                    <input class="form-control" value="<?php echo $linha['nomeArera'] ?>" type="text" name="nome" id="idnome" required pattern="[a-zA-Zà-úÀ-Ú\s]+"
