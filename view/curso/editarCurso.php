    ...
    <div class="container">
        <div class="row mb-4 mt-4">
            <div class="alert alert-light" role="alert"style="background-color: #198754;">
                <h1  style="color: #000000;">Editar Curso</h1>
            </div>
        </div>
        <?php
        try{
        ...
        <input value="<?php echo $linha['idCurso'] ?>" type="text" name="idCurso" id="idCurso" hidden>
            <div class="row mb-3">
                <div class="col col-md-9">
                    ...
                    <input class="form-control" value="<?php echo $linha['nomeCurso'] ?>" type="text" name="nome" id="idnome" required pattern="[a-zA-Zà-úÀ-Ú\s]+"
           title="Por favor, insira somente letras e espaços">
                </div>
                <div class="col col-md-3">
                    <label class="form-label" for="idnota">Nota do Curso</label>
                    <input class="form-control" type="number" value="<?php echo $linha['notaCurso'] ?>" name="nota" id="idnota" required>
                </div>
            </div>
            <?php 
                }
